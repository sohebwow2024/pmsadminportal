...
const NewRegisterGuest = ({ open, handleOpen, handleGuestOptions }) => {
    ...
    const onSubmit = () => {
        setDisplay(true)
        if (guestName.trim() && guestLastName.trim() && mobPrefix.trim() && mobNumber.trim() && countryId && stateId && cityId && pinCode.trim() && address.trim() !== '') {
            guestRegister()
            handleOpen()
            setGuestName('')
            setGuestLastName('')
                                ...
                                <Col className='mx-1'>
                                    ...
                                    <Input
                                            ...
                                            onChange={e => {
                                                ...
                                                const validInput = value.replace(/[^a-zA-Z0-9/s\s]/g, '');
                                                setAddress(validInput);
                                            }}
                                            invalid={display && address.trim() === ''}
                                        />
...
export default NewRegisterGuest