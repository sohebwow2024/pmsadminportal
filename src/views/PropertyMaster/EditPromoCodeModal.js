...
const EditPromoCodeModal = ({ updateOpen, handleUpdateOpen, promoId, getPromoCodeData }) => {
    ...
    console.log("refundDiscounT", isRefundable);
    ...
    const deleteBDateInput = async (id, index) => {
        try {
            axios.post(`/promocode/deletebyBlackOutDateId/${id}`, {}, {
                headers: {
                    LoginID,
                    Token,
                }
    ...
    const deleteRoomInput = async (id, index) => {
        ...
        try {
            axios.post(`/promocode/deletebyApplicableRoomId/${id}`, {}, {
                headers: {
                    LoginID,
                    Token,
                }
    ...
    const savePromotion = async () => {
        ...
        try {
            ...
            const res = await axios.post('/promocode/update', promotionData, {
                headers: {
                    LoginID,
                    Token,
                }
    ...
    const getPromoUpdateData = async () => {
        try {
            const res = await axios.get(`/promocode/getbyid?PromotionID=${promoId}`, {
                headers: {
                    LoginID,
                    Token
                }
            ...
            setPromoCode(data[0][0]?.promoCode)
            setNoOfUse(data[0][0]?.noOfUse)
                ...
                <ModalBody>
                    <Form>
                        <Row>
                            ...
                            <Col lg='6' className='mb-1'>
                                <Label className='form-label' for='promo'>Promotion Code <span className='text-danger'>*</span></Label>
                                <Input
                                    type='text'
                                    name='promo'
                                    id='promo'
                                ...
                                />
                                {showErrors && promoCode === '' && <p className='text-danger'>Promo Name is required</p>}
                            </Col>
                                    ...
                                    <Table responsive className='mt-2'>
                                        ...
                                        <tbody>
                                            {roomCheckData && roomCheckData?.map((a, index) => {
                                                console.log("roomCheckData", roomCheckData);
                                                return (
                                                    <>
                                                        <tr>
