...
const EditGuest = ({ open, handleOpen, guestData }) => {
    ...
    const handleUpdateGuestDetail = async (e) => {
        ...
        if (guestName && guestLastName && mobPrefix && mobNumber && guestEmail && guestDob && pinCode && address && countryId && stateId && cityId !== '') {
            try {
                let obj = {
                    LoginID,
                    Token,
