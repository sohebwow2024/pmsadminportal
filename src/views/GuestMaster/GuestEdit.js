...
const GuestEdit = ({ open, handleOpen, guestData,onRefresh}) => {
  ...
  const getCountryData = async () => {
    try {
      ...
      if (data.length > 0) {
        ...
        console.log("countryres", options);
  ...
  const handleUpdateGuestDetail = async (e) => {
    ...
    if (
      ...
      try {
        ...
        console.log("responseGuestDetails", res);
